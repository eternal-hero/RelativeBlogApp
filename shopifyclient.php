...
class ShopifyClient {
	...
	public function call($method, $path, $params=array())
	{
		...
		if (isset($response['errors']) or (isset($this->last_response_headers['http_status_code']) && $this->last_response_headers['http_status_code'] >= 400))
...
class ShopifyApiException extends Exception
{
	...
	function __construct($method, $path, $params, $response_headers, $response)
	{
		...
		$this->path = $path;
		$this->params = $params;
		if(!isset($response_headers['http_status_message'])){
			$response_headers['http_status_message'] = "";
		}
		if(!isset($response_headers['http_status_code'])){
			$response_headers['http_status_code'] = 200;
		}
